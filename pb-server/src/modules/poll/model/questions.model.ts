import { index, boolean, integer, pgEnum, pgTable, text, timestamp, uuid } from "drizzle-orm/pg-core";
...
export const questions = pgTable(
	...
	(table) => [index("questions_poll_order_idx").on(table.pollId, table.orderIndex)]
);
